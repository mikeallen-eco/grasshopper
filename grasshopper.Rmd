...
df <- cbind.data.frame(as.data.frame(points.w.bg), values[,2:20], vals) %>%
...
write.csv(df, "output/train_dataset.csv", row.names = F)
...
plot(env[[20]], xlim = c(-109, -50), ylim = c(15, 50))
...
clim_fut <- geodata::cmip6_world(model='ACCESS-ESM1-5', ssp='245', time='2061-2080', var='bioc', download=T, res=5, path="/Users/mikea/Documents/mikedata/grasshopper/202407/")
